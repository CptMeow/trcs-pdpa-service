    ...
    <div id="loading-bg">
      <div class="loading-logo">
        ...
        <svg width="100" height="80" viewBox="0 0 100 80" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <mask id="mask0_78_100113" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="27" y="10" width="35" height="63">
            <path
          ...
          <g mask="url(#mask0_78_100113)">
            ...
            <path d="M37.067 21.6277C34.3841 25.8233 34.9701 29.3447 38.8249 32.1917C43.0036 34.0863 45.8088 35.3109 47.2406 35.8655L56.0284 37.6177L61.9052 25.3834C56.0805 16.1464 53.0403 11.324 52.7844 10.916C52.3823 11.2065 47.1432 14.7771 37.067 21.6277Z" fill="var(--initial-loader-color)" />
            <path d="M37.067 21.6277C34.3841 25.8233 34.9701 29.3447 38.8249 32.1917C43.0036 34.0863 45.8088 35.3109 47.2406 35.8655L56.0284 37.6177L61.9052 25.3834C56.0805 16.1464 53.0403 11.324 52.7844 10.916C52.3823 11.2065 47.1432 14.7771 37.067 21.6277Z" fill="white" fill-opacity="0.2" />
            <path

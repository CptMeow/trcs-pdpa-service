...
@section('content-header')
  ...
  <div class="col-6 text-right">
    @canany(['appeal-comment-create', 'appeal-manage'])
      <a href="{{ route('appeals.comment.create', $appeal->appeal_id) }}" class="btn btn-warning btn-sm text-white">
        <i class="fas fa-comment"></i> เพิ่มความเห็น</a>
    @endcanany
          ...
          <div class="card-header text-white bg-light">
            <div class="row">
              ...
              <div class="col-6 text-right d-none">
                @canany(['appeal-comment-create', 'appeal-manage'])
                  <a href="{{ route('appeals.comment.create', $appeal->appeal_id) }}" class="btn btn-warning btn-xs">
                    <i class="fas fa-chat"></i></a>
                @endcanany
                @canany(['appeal-edit', 'appeal-manage'])
